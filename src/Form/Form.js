...
const Form = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs.sendForm('service_htz18n8', 'template_q8lg3oa', form.current, 'QgfKRvDyGdxr1iWcp')
          .then((result) => {
    ...
    return (
        <div id='contact' className=' bg-slate-500 p-20'>
            ...
            <form ref={form} onSubmit={sendEmail} className='container mx-auto flex flex-col md:w-3/5 gap-5'>
            <div>
