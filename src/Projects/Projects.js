...
const Projects = () => {
  return (
    ...
    <h1 className="text-center text-4xl font-bold mb-10 text-orange-400">Projects</h1>
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 container mx-auto">
      <div className="card card-compact bg-slate-900 shadow-xl">
        ...
        <div className="card-body text-white">
          ...
          <p>A travel guide project. User can  know about the cost of the each tourist spot.
            Also they will know how can they go there
          </p>
      ...
      <div className="card card-compact bg-slate-900 shadow-xl">
        ...
        <div className="card-body text-white">
          ...
          <p>This is second-hand product buys and sells website. Where a seller can post their product. A payment option enable this website</p>
          <div className="card-actions justify-end">
            <button className="btn btn-primary">Details</button>
          </div>
        </div>
      ...
      <div className="card card-compact bg-slate-900 shadow-xl">
        ...
        <div className="card-body text-white">
          ...
          <p>A digital course selling website. Here user can buys theire preffered programming language courses. Before buy any course user must be log in first</p>
          <div className="card-actions justify-end">
            <button className="btn btn-primary">Details</button>
          </div>
        </div>
